...
#' @export
cc.mids <- function(x) return(x$data[cci(x), , drop = FALSE])

#' @export
cc.matrix <- function(x) return(x[cci(x), , drop = FALSE])

#' @export
cc.data.frame <- function(x) return(x[cci(x), , drop = FALSE])

#' @export
cc.default <- function(x) return(x[cci(x)])
...
#' @export
ic.mids <- function(x) return(x$data[ici(x), , drop = FALSE])

#' @export
ic.matrix <- function(x) return(x[ici(x), , drop = FALSE])

#' @export
ic.data.frame <- function(x) return(x[ici(x), , drop = FALSE])

#' @export
ic.default <- function(x) return(x[ici(x)])